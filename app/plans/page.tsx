...
import { Check, Star, Crown, Zap, Shield, Users, ArrowRight } from "lucide-react"
  ...
  const features = [
    {
      ...
      title: "Acesso Seguro",
      description: "Plataforma protegida com autenticação avançada",
    },
    {
      icon: <Users className="h-5 w-5" />,
      title: "Múltiplos Usuários",
      description: "Adicione membros da sua equipe (planos Pro e Enterprise)",
    },
    {
      icon: <Zap className="h-5 w-5" />,
      title: "Atualizações Constantes",
      description: "Novos conteúdos e recursos adicionados mensalmente",
    },
  ]
  ...
  const testimonials = [
    {
      ...
      plan: "Profissional",
      content:
        "O plano profissional da HD Designer revolucionou nosso processo criativo. Acesso a templates de qualidade e consultoria especializada.",
      rating: 5,
    },
    {
      name: "Marina Santos",
      ...
      plan: "Empresarial",
      content:
        "Com o plano empresarial, nossa agência conseguiu escalar os projetos mantendo a qualidade. O suporte é excepcional!",
      rating: 5,
    },
  ]
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed mb-8">
              Acesse conteúdos exclusivos, templates premium e consultoria especializada. Todos os planos incluem acesso
              à nossa plataforma e suporte dedicado.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-center">
            ...
            {plans.map((plan) => (
              <Card
                key={plan.id}
                className={`relative ${plan.popular ? "ring-2 ring-primary scale-105" : ""} hover:shadow-xl transition-all duration-300 bg-background border-border`}
              >
                {plan.popular && (
                ...
                <CardHeader className="text-center pb-8">
                  ...
                  <CardDescription className="text-base mt-2 text-muted-foreground">{plan.description}</CardDescription>
                  <div className="mt-6">
                    <div className="flex items-baseline justify-center">
                      <span className="text-4xl font-bold text-foreground">R$ {getPrice(plan)}</span>
                      <span className="text-muted-foreground ml-2">/{billingCycle === "monthly" ? "mês" : "ano"}</span>
                    </div>
                    {billingCycle === "yearly" && (
                      <p className="text-sm text-green-500 mt-2">Economize R$ {getSavings(plan)} por ano</p>
                    )}
                  </div>
                </CardHeader>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Funcionalidades essenciais para potencializar seus projetos de design
            </p>
          </div>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-4">O que nossos assinantes dizem</h2>
            <p className="text-xl text-muted-foreground">Depoimentos reais de quem usa nossos planos</p>
          </div>
      ...
      <section className="py-20 bg-card">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">Tire suas dúvidas sobre nossos planos</p>
          </div>
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <Card className="bg-background border-border">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Sim, você pode cancelar sua assinatura a qualquer momento. Não há taxas de cancelamento e você manterá
            ...
            <Card className="bg-background border-border">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Claro! Você pode alterar seu plano a qualquer momento. O valor será ajustado proporcionalmente no
            ...
            <Card className="bg-background border-border">
              <CardHeader>
                <CardTitle className="text-lg text-foreground">Os downloads têm limite de uso comercial?</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
                  Todos os nossos recursos podem ser usados comercialmente. Você recebe licença completa para uso em
            ...
            <Card className="bg-background border-border">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  A consultoria é realizada por videochamada com nossos especialistas. Você pode agendar sessões para
                  tirar dúvidas sobre projetos, estratégias de marca e muito mais.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-20 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Escolha seu plano e tenha acesso imediato a todos os recursos da HD Designer
          </p>
